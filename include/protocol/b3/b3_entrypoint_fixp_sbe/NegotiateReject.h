...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_NEGOTIATEREJECT_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_NEGOTIATEREJECT_CXX_H_
...
public:
    ...
    NegotiateReject(char *buffer, const std::uint64_t bufferLength) :
        NegotiateReject(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    NegotiateReject(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        NegotiateReject(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    NegotiateReject &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = NegotiateReject(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    NegotiateReject &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    NegotiateReject &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = NegotiateReject(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    NegotiateReject &sbeRewind()
    {
    ...
    {
        NegotiateReject skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    {
        return MessageType::Value::NegotiateReject;
    }
    ...
    {
        return static_cast<std::uint8_t>(MessageType::Value::NegotiateReject);
    }
    ...
    NegotiateReject &sessionID(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    NegotiateReject &sessionVerID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    NegotiateReject &enteringFirm(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    SBE_NODISCARD static const char *negotiationRejectCodeMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t negotiationRejectCodeId() SBE_NOEXCEPT
    {
        return 35522;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t negotiationRejectCodeSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool negotiationRejectCodeInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t negotiationRejectCodeEncodingOffset() SBE_NOEXCEPT
    {
        return 24;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t negotiationRejectCodeEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t negotiationRejectCodeRaw() const SBE_NOEXCEPT
    {
        std::uint8_t val;
    ...
    SBE_NODISCARD NegotiationRejectCode::Value negotiationRejectCode() const
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 24, sizeof(std::uint8_t));
        return NegotiationRejectCode::get((val));
    }

    NegotiateReject &negotiationRejectCode(const NegotiationRejectCode::Value value) SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD static const char *currentSessionVerIDMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t currentSessionVerIDId() SBE_NOEXCEPT
    {
        return 35523;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t currentSessionVerIDSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool currentSessionVerIDInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t currentSessionVerIDEncodingOffset() SBE_NOEXCEPT
    {
        return 28;
    }

    static SBE_CONSTEXPR std::uint64_t currentSessionVerIDNullValue() SBE_NOEXCEPT
    {
        return UINT64_C(0x0);
    }

    static SBE_CONSTEXPR std::uint64_t currentSessionVerIDMinValue() SBE_NOEXCEPT
    {
        return UINT64_C(0x0);
    }

    static SBE_CONSTEXPR std::uint64_t currentSessionVerIDMaxValue() SBE_NOEXCEPT
    {
        return UINT64_C(0xfffffffffffffffe);
    }

    static SBE_CONSTEXPR std::size_t currentSessionVerIDEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::uint64_t currentSessionVerID() const SBE_NOEXCEPT
    {
        std::uint64_t val;
    ...
    NegotiateReject &currentSessionVerID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, NegotiateReject &_writer)
{
    NegotiateReject writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "NegotiateReject", )";
    ...
    builder << ", ";
    builder << R"("negotiationRejectCode": )";
    builder << '"' << writer.negotiationRejectCode() << '"';

    builder << ", ";
    builder << R"("currentSessionVerID": )";
    builder << +writer.currentSessionVerID();
