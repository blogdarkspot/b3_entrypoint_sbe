...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_ORDERCANCELREQUEST_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_ORDERCANCELREQUEST_CXX_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(105);
    ...
    {
        OrderCancelRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    {
        return MessageType::Value::OrderCancelRequest;
    }
    ...
    {
        return static_cast<std::uint8_t>(MessageType::Value::OrderCancelRequest);
    }
...
public:
    ...
    OrderCancelRequest &clOrdID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelRequest &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderCancelRequest &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderCancelRequest &origClOrdID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 52, sizeof(char));
        return (val);
    }
    ...
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 52, &val, sizeof(char));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 53, sizeof(std::uint8_t));
        return (val);
    }

    SBE_NODISCARD ExecRestatementReasonValidForSingleCancel::Value execRestatementReason() const
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 53, sizeof(std::uint8_t));
        return ExecRestatementReasonValidForSingleCancel::get((val));
    }

    OrderCancelRequest &execRestatementReason(const ExecRestatementReasonValidForSingleCancel::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 53, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    OrderCancelRequest &senderLocation(const std::uint64_t index, const char value)
    {
        if (index >= 10)
        {
    ...
    OrderCancelRequest &putSenderLocation(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 56, src, sizeof(char) * 10);
        return *this;
    }
    ...
    #if __cplusplus >= 201703L
    OrderCancelRequest &putSenderLocation(const std::string_view str)
    {
    ...
    #else
    OrderCancelRequest &putSenderLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 10)
        {
    ...
    OrderCancelRequest &enteringTrader(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    OrderCancelRequest &putEnteringTrader(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 66, src, sizeof(char) * 5);
        return *this;
    }
    ...
    #if __cplusplus >= 201703L
    OrderCancelRequest &putEnteringTrader(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    #else
    OrderCancelRequest &putEnteringTrader(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    OrderCancelRequest &executingTrader(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    OrderCancelRequest &putExecutingTrader(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderCancelRequest &putExecutingTrader(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    #else
    OrderCancelRequest &putExecutingTrader(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    OrderCancelRequest &putDeskID(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    OrderCancelRequest &putDeskID(const std::string &str)
    {
        if (str.length() > 20)
        {
    ...
    #if __cplusplus >= 201703L
    OrderCancelRequest &putDeskID(const std::string_view str)
    {
        if (str.length() > 20)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    OrderCancelRequest &putMemo(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    OrderCancelRequest &putMemo(const std::string &str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    OrderCancelRequest &putMemo(const std::string_view str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
