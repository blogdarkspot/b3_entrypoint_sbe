...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_SIDE_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_SIDE_CXX_H_
...
public:
    ...
    static Side::Value get(const char value)
    {
        switch (value)
        {
    ...
    static const char *c_str(const Side::Value value)
    {
        switch (value)
        {
            case BUY: return "BUY";
    ...
    friend std::basic_ostream<CharT, Traits> & operator << (
        std::basic_ostream<CharT, Traits> &os, Side::Value m)
    {
