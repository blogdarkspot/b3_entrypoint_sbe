...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_ORDERCANCELREPLACEREQUEST_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_ORDERCANCELREPLACEREQUEST_CXX_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(104);
    ...
    {
        return static_cast<std::uint16_t>(104);
    }
    ...
    OrderCancelReplaceRequest &sbeRewind()
    {
    ...
    {
        OrderCancelReplaceRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    {
        return MessageType::Value::OrderCancelReplaceRequest;
    }
    ...
    {
        return static_cast<std::uint8_t>(MessageType::Value::OrderCancelReplaceRequest);
    }
...
public:
    ...
    OrderCancelReplaceRequest &ordTagID(const std::uint8_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceRequest &mmProtectionReset(const Boolean::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderCancelReplaceRequest &clOrdID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceRequest &account(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceRequest &senderLocation(const std::uint64_t index, const char value)
    {
        if (index >= 10)
        {
    ...
    OrderCancelReplaceRequest &putSenderLocation(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceRequest &putSenderLocation(const std::string_view str)
    {
    ...
    #else
    OrderCancelReplaceRequest &putSenderLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 10)
        {
    ...
    OrderCancelReplaceRequest &enteringTrader(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    OrderCancelReplaceRequest &putEnteringTrader(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceRequest &putEnteringTrader(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    #else
    OrderCancelReplaceRequest &putEnteringTrader(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    OrderCancelReplaceRequest &selfTradePreventionInstruction(const SelfTradePreventionInstruction::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderCancelReplaceRequest &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderCancelReplaceRequest &routingInstruction(const RoutingInstruction::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderCancelReplaceRequest &orderQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    OrderCancelReplaceRequest &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderCancelReplaceRequest &origClOrdID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    {
        m_stopPx.wrap(m_buffer, m_offset + 92, m_actingVersion, m_bufferLength);
        return m_stopPx;
    }
    ...
    OrderCancelReplaceRequest &minQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderCancelReplaceRequest &maxFloor(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD char executingTrader(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 116 + (index * 1), sizeof(char));
        return (val);
    }

    OrderCancelReplaceRequest &executingTrader(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 116 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getExecutingTrader(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 116, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    OrderCancelReplaceRequest &putExecutingTrader(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 116, src, sizeof(char) * 5);
        return *this;
    }

    SBE_NODISCARD std::string getExecutingTraderAsString() const
    {
        const char *buffer = m_buffer + m_offset + 116;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceRequest &putExecutingTrader(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
        ...
        std::memcpy(m_buffer + m_offset + 116, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 5; ++start)
        {
            m_buffer[m_offset + 116 + start] = 0;
        }

        return *this;
    }
    #else
    OrderCancelReplaceRequest &putExecutingTrader(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
        ...
        std::memcpy(m_buffer + m_offset + 116, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 5; ++start)
        {
            m_buffer[m_offset + 116 + start] = 0;
        }
    ...
    SBE_NODISCARD std::uint8_t accountTypeRaw() const SBE_NOEXCEPT
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 121, sizeof(std::uint8_t));
        return (val);
    }
    ...
    OrderCancelReplaceRequest &accountType(const AccountType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 121, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 122, sizeof(std::uint16_t));
    ...
    OrderCancelReplaceRequest &expireDate(const std::uint16_t value) SBE_NOEXCEPT
    {
        ...
        std::memcpy(m_buffer + m_offset + 122, &val, sizeof(std::uint16_t));
        return *this;
    }
...
public:
    ...
    {
        m_custodianInfo.wrap(m_buffer, m_offset + 124, m_actingVersion, m_bufferLength);
...
public:
    ...
    {
        m_investorID.wrap(m_buffer, m_offset + 136, m_actingVersion, m_bufferLength);
        return m_investorID;
    }
    ...
    OrderCancelReplaceRequest &putDeskID(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    OrderCancelReplaceRequest &putDeskID(const std::string &str)
    {
        if (str.length() > 20)
        {
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceRequest &putDeskID(const std::string_view str)
    {
        if (str.length() > 20)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    OrderCancelReplaceRequest &putMemo(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    OrderCancelReplaceRequest &putMemo(const std::string &str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceRequest &putMemo(const std::string_view str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
{
    OrderCancelReplaceRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
