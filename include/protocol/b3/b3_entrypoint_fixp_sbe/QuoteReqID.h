...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_QUOTEREQID_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_QUOTEREQID_CXX_H_
...
public:
    ...
    QuoteReqID(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        QuoteReqID(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    QuoteReqID(
        char *buffer,
        const std::uint64_t bufferLength) :
        QuoteReqID(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    QuoteReqID &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = QuoteReqID(buffer, offset, bufferLength, actingVersion);
    }
    ...
    QuoteReqID &length(const std::uint8_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, QuoteReqID &writer)
{
    builder << '{';
    builder << R"("length": )";
