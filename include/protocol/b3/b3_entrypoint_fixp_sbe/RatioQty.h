...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_RATIOQTY_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_RATIOQTY_CXX_H_
...
public:
    ...
    RatioQty &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = RatioQty(buffer, offset, bufferLength, actingVersion);
    }
