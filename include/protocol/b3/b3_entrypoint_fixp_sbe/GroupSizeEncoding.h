...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_GROUPSIZEENCODING_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_GROUPSIZEENCODING_CXX_H_
...
public:
    ...
    GroupSizeEncoding &numInGroup(const std::uint8_t value) SBE_NOEXCEPT
    {
