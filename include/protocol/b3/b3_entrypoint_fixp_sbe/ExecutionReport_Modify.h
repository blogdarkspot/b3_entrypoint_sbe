...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_EXECUTIONREPORT_MODIFY_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_EXECUTIONREPORT_MODIFY_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(160);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(201);
    ...
    ExecutionReport_Modify(char *buffer, const std::uint64_t bufferLength) :
        ExecutionReport_Modify(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionReport_Modify(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionReport_Modify(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ExecutionReport_Modify &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = ExecutionReport_Modify(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    ExecutionReport_Modify &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionReport_Modify(
            buffer,
    ...
    ExecutionReport_Modify &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionReport_Modify(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    ExecutionReport_Modify &sbeRewind()
    {
    ...
    {
        ExecutionReport_Modify skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    {
        return MessageType::Value::ExecutionReport_Modify;
    }
    ...
    {
        return static_cast<std::uint8_t>(MessageType::Value::ExecutionReport_Modify);
    }
...
public:
    ...
    ExecutionReport_Modify &side(const Side::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReport_Modify &ordStatus(const OrdStatus::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReport_Modify &clOrdID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReport_Modify &secondaryOrderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_Modify &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_Modify &leavesQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_Modify &account(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReport_Modify &execID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    ExecutionReport_Modify &cumQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    {
        m_marketSegmentReceivedTime.wrap(m_buffer, m_offset + 80, m_actingVersion, m_bufferLength);
    ...
    ExecutionReport_Modify &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 96, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReport_Modify &origClOrdID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 96, &val, sizeof(std::uint64_t));
        return *this;
    }

    SBE_NODISCARD static const char *protectionPriceMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t protectionPriceId() SBE_NOEXCEPT
    {
        return 35001;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t protectionPriceSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool protectionPriceInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t protectionPriceEncodingOffset() SBE_NOEXCEPT
    {
        return 104;
    }

private:
    PriceOptional m_protectionPrice;

public:
    SBE_NODISCARD PriceOptional &protectionPrice()
    {
        m_protectionPrice.wrap(m_buffer, m_offset + 104, m_actingVersion, m_bufferLength);
        return m_protectionPrice;
    }
    ...
    {
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 112, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    ExecutionReport_Modify &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 112, &val, sizeof(std::uint16_t));
        return *this;
    }
    ...
    ExecutionReport_Modify &workingIndicator(const Boolean::Value value) SBE_NOEXCEPT
    {
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 115, sizeof(char));
        return (val);
    }
    ...
    ExecutionReport_Modify &multiLegReportingType(const MultiLegReportingType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 115, &val, sizeof(char));
        return *this;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 116, sizeof(char));
        return (val);
    }
    ...
    ExecutionReport_Modify &ordType(const OrdType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 116, &val, sizeof(char));
        return *this;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 117, sizeof(char));
        return (val);
    }
    ...
    ExecutionReport_Modify &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 117, &val, sizeof(char));
        return *this;
    }
    ...
    {
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 118, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    ExecutionReport_Modify &expireDate(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 118, &val, sizeof(std::uint16_t));
        return *this;
    }
    ...
    ExecutionReport_Modify &orderQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    {
        m_price.wrap(m_buffer, m_offset + 128, m_actingVersion, m_bufferLength);
        return m_price;
    }
...
public:
    ...
    {
        m_stopPx.wrap(m_buffer, m_offset + 136, m_actingVersion, m_bufferLength);
        return m_stopPx;
    }
    ...
    ExecutionReport_Modify &minQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 152, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReport_Modify &maxFloor(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 152, &val, sizeof(std::uint64_t));
        return *this;
    }
    ...
    ExecutionReport_Modify &putDeskID(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    ExecutionReport_Modify &putDeskID(const std::string &str)
    {
        if (str.length() > 20)
        {
    ...
    #if __cplusplus >= 201703L
    ExecutionReport_Modify &putDeskID(const std::string_view str)
    {
        if (str.length() > 20)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    ExecutionReport_Modify &putMemo(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    ExecutionReport_Modify &putMemo(const std::string &str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    ExecutionReport_Modify &putMemo(const std::string_view str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ExecutionReport_Modify &_writer)
{
    ExecutionReport_Modify writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionReport_Modify", )";
    ...
    builder << ", ";
    builder << R"("protectionPrice": )";
    builder << writer.protectionPrice();
