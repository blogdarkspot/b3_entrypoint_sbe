...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_EXECUTIONREPORT_TRADE_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_EXECUTIONREPORT_TRADE_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(154);
    ...
    ExecutionReport_Trade(char *buffer, const std::uint64_t bufferLength) :
        ExecutionReport_Trade(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionReport_Trade(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionReport_Trade(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ExecutionReport_Trade &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = ExecutionReport_Trade(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    ExecutionReport_Trade &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionReport_Trade(
            buffer,
    ...
    ExecutionReport_Trade &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionReport_Trade(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    ExecutionReport_Trade &sbeRewind()
    {
    ...
    {
        ExecutionReport_Trade skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    {
        return MessageType::Value::ExecutionReport_Trade;
    }
    ...
    {
        return static_cast<std::uint8_t>(MessageType::Value::ExecutionReport_Trade);
    }
...
public:
    ...
    ExecutionReport_Trade &side(const Side::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReport_Trade &ordStatus(const OrdStatus::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReport_Trade &clOrdID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReport_Trade &secondaryOrderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_Trade &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_Trade &account(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReport_Trade &lastQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    ExecutionReport_Trade &execID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    ExecutionReport_Trade &leavesQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_Trade &cumQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_Trade &aggressorIndicator(const Boolean::Value value) SBE_NOEXCEPT
    {
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 97, sizeof(char));
        return (val);
    }

    SBE_NODISCARD ExecType::Value execType() const
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 97, sizeof(char));
        return ExecType::get((val));
    }

    ExecutionReport_Trade &execType(const ExecType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 97, &val, sizeof(char));
        return *this;
    }

    SBE_NODISCARD static const char *orderCategoryMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t orderCategoryId() SBE_NOEXCEPT
    {
        return 1115;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t orderCategorySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool orderCategoryInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t orderCategoryEncodingOffset() SBE_NOEXCEPT
    {
        return 98;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t orderCategoryEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD char orderCategoryRaw() const SBE_NOEXCEPT
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 98, sizeof(char));
        return (val);
    }

    SBE_NODISCARD OrderCategory::Value orderCategory() const
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 98, sizeof(char));
        return OrderCategory::get((val));
    }

    ExecutionReport_Trade &orderCategory(const OrderCategory::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 98, &val, sizeof(char));
        return *this;
    }

    SBE_NODISCARD static const char *multiLegReportingTypeMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t multiLegReportingTypeId() SBE_NOEXCEPT
    {
        return 442;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t multiLegReportingTypeSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool multiLegReportingTypeInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t multiLegReportingTypeEncodingOffset() SBE_NOEXCEPT
    {
        return 99;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t multiLegReportingTypeEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD char multiLegReportingTypeRaw() const SBE_NOEXCEPT
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 99, sizeof(char));
        return (val);
    }

    SBE_NODISCARD MultiLegReportingType::Value multiLegReportingType() const
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 99, sizeof(char));
        return MultiLegReportingType::get((val));
    }

    ExecutionReport_Trade &multiLegReportingType(const MultiLegReportingType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 99, &val, sizeof(char));
        return *this;
    }
    ...
    ExecutionReport_Trade &tradeID(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    {
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset + 104, sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    ExecutionReport_Trade &contraBroker(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 104, &val, sizeof(std::uint32_t));
        return *this;
    }
    ...
    ExecutionReport_Trade &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_Trade &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    static SBE_CONSTEXPR std::uint8_t totNoRelatedSymNullValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint8_t>(0);
    }

    static SBE_CONSTEXPR std::uint8_t totNoRelatedSymMinValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint8_t>(0);
    }

    static SBE_CONSTEXPR std::uint8_t totNoRelatedSymMaxValue() SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD std::uint8_t totNoRelatedSym() const SBE_NOEXCEPT
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 118, sizeof(std::uint8_t));
        return (val);
    }

    ExecutionReport_Trade &totNoRelatedSym(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 118, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    ExecutionReport_Trade &secondaryExecID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_Trade &execRefID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_Trade &crossID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 144, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }
    ...
    ExecutionReport_Trade &crossedIndicator(const CrossedIndicator::Value value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 144, &val, sizeof(std::uint16_t));
        return *this;
    }
    ...
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 146, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReport_Trade &orderQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 146, &val, sizeof(std::uint64_t));
        return *this;
    }
    ...
    ExecutionReport_Trade &putDeskID(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    ExecutionReport_Trade &putDeskID(const std::string &str)
    {
        if (str.length() > 20)
        {
    ...
    #if __cplusplus >= 201703L
    ExecutionReport_Trade &putDeskID(const std::string_view str)
    {
        if (str.length() > 20)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    ExecutionReport_Trade &putMemo(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    ExecutionReport_Trade &putMemo(const std::string &str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    ExecutionReport_Trade &putMemo(const std::string_view str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ExecutionReport_Trade &_writer)
{
    ExecutionReport_Trade writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionReport_Trade", )";
    ...
    builder << ", ";
    builder << R"("orderCategory": )";
    builder << '"' << writer.orderCategory() << '"';

    builder << ", ";
    builder << R"("multiLegReportingType": )";
    builder << '"' << writer.multiLegReportingType() << '"';
