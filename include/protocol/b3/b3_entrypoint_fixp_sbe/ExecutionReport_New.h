...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_EXECUTIONREPORT_NEW_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_EXECUTIONREPORT_NEW_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(144);
    ...
    ExecutionReport_New(char *buffer, const std::uint64_t bufferLength) :
        ExecutionReport_New(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionReport_New(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionReport_New(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ExecutionReport_New &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = ExecutionReport_New(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    ExecutionReport_New &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionReport_New(
            buffer,
    ...
    ExecutionReport_New &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionReport_New(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    ExecutionReport_New &sbeRewind()
    {
    ...
    {
        ExecutionReport_New skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    {
        return MessageType::Value::ExecutionReport_New;
    }
    ...
    {
        return static_cast<std::uint8_t>(MessageType::Value::ExecutionReport_New);
    }
...
public:
    ...
    ExecutionReport_New &side(const Side::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReport_New &ordStatus(const OrdStatus::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReport_New &clOrdID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReport_New &secondaryOrderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_New &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_New &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_New &account(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReport_New &execID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    {
        m_protectionPrice.wrap(m_buffer, m_offset + 80, m_actingVersion, m_bufferLength);
    ...
    {
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 88, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    ExecutionReport_New &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 88, &val, sizeof(std::uint16_t));
        return *this;
    }
    ...
    ExecutionReport_New &workingIndicator(const Boolean::Value value) SBE_NOEXCEPT
    {
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 91, sizeof(char));
        return (val);
    }
    ...
    ExecutionReport_New &multiLegReportingType(const MultiLegReportingType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 91, &val, sizeof(char));
        return *this;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 92, sizeof(char));
        return (val);
    }
    ...
    ExecutionReport_New &ordType(const OrdType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 92, &val, sizeof(char));
        return *this;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 93, sizeof(char));
        return (val);
    }
    ...
    ExecutionReport_New &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 93, &val, sizeof(char));
        return *this;
    }
    ...
    {
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 94, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    ExecutionReport_New &expireDate(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 94, &val, sizeof(std::uint16_t));
        return *this;
    }
    ...
    ExecutionReport_New &orderQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    {
        m_price.wrap(m_buffer, m_offset + 104, m_actingVersion, m_bufferLength);
        return m_price;
    }
...
public:
    ...
    {
        m_stopPx.wrap(m_buffer, m_offset + 112, m_actingVersion, m_bufferLength);
        return m_stopPx;
    }
    ...
    ExecutionReport_New &minQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_New &maxFloor(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_New &crossID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReport_New &putDeskID(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    ExecutionReport_New &putDeskID(const std::string &str)
    {
        if (str.length() > 20)
        {
    ...
    #if __cplusplus >= 201703L
    ExecutionReport_New &putDeskID(const std::string_view str)
    {
        if (str.length() > 20)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    ExecutionReport_New &putMemo(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    ExecutionReport_New &putMemo(const std::string &str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    ExecutionReport_New &putMemo(const std::string_view str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ExecutionReport_New &_writer)
{
    ExecutionReport_New writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionReport_New", )";
