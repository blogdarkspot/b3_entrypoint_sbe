...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_DESKIDENCODING_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_DESKIDENCODING_CXX_H_
...
public:
    ...
    DeskIDEncoding(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        DeskIDEncoding(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    DeskIDEncoding(
        char *buffer,
        const std::uint64_t bufferLength) :
        DeskIDEncoding(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    DeskIDEncoding &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = DeskIDEncoding(buffer, offset, bufferLength, actingVersion);
    }
    ...
    {
        return static_cast<std::uint8_t>(20);
    }
    ...
    DeskIDEncoding &length(const std::uint8_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, DeskIDEncoding &writer)
{
    builder << '{';
    builder << R"("length": )";
