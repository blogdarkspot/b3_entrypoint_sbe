...
#ifndef _B3_ENTRYPOINT_FIXP_SBE_QUOTEREQUESTREJECT_CXX_H_
#define _B3_ENTRYPOINT_FIXP_SBE_QUOTEREQUESTREJECT_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(103);
    ...
    QuoteRequestReject(char *buffer, const std::uint64_t bufferLength) :
        QuoteRequestReject(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    QuoteRequestReject(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        QuoteRequestReject(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    QuoteRequestReject &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = QuoteRequestReject(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    QuoteRequestReject &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    QuoteRequestReject &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = QuoteRequestReject(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    QuoteRequestReject &sbeRewind()
    {
    ...
    {
        QuoteRequestReject skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    {
        return MessageType::Value::QuoteRequestReject;
    }
    ...
    {
        return static_cast<std::uint8_t>(MessageType::Value::QuoteRequestReject);
    }
...
public:
    ...
    SBE_NODISCARD static const char *quoteRequestRejectReasonMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
    ...
    static SBE_CONSTEXPR std::uint16_t quoteRequestRejectReasonId() SBE_NOEXCEPT
    {
        return 658;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t quoteRequestRejectReasonSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool quoteRequestRejectReasonInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t quoteRequestRejectReasonEncodingOffset() SBE_NOEXCEPT
    {
        return 20;
    }

    static SBE_CONSTEXPR std::uint32_t quoteRequestRejectReasonNullValue() SBE_NOEXCEPT
    {
        return UINT32_C(0x0);
    }

    static SBE_CONSTEXPR std::uint32_t quoteRequestRejectReasonMinValue() SBE_NOEXCEPT
    {
        return UINT32_C(0x0);
    }

    static SBE_CONSTEXPR std::uint32_t quoteRequestRejectReasonMaxValue() SBE_NOEXCEPT
    {
        return UINT32_C(0xfffffffe);
    }

    static SBE_CONSTEXPR std::size_t quoteRequestRejectReasonEncodingLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::uint32_t quoteRequestRejectReason() const SBE_NOEXCEPT
    {
        std::uint32_t val;
    ...
    QuoteRequestReject &quoteRequestRejectReason(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    QuoteRequestReject &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    QuoteRequestReject &quoteID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    QuoteRequestReject &tradeID(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    QuoteRequestReject &contraBroker(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
public:
    ...
    QuoteRequestReject &enteringTrader(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    QuoteRequestReject &putEnteringTrader(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 56, src, sizeof(char) * 5);
        return *this;
    }
    ...
    #if __cplusplus >= 201703L
    QuoteRequestReject &putEnteringTrader(const std::string_view str)
    {
    ...
    #else
    QuoteRequestReject &putEnteringTrader(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    QuoteRequestReject &settlType(const SettlType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
...
public:
    ...
    {
        m_price.wrap(m_buffer, m_offset + 62, m_actingVersion, m_bufferLength);
        return m_price;
    }
    ...
    QuoteRequestReject &orderQty(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    QuoteRequestReject &senderLocation(const std::uint64_t index, const char value)
    {
        if (index >= 10)
        {
    ...
    QuoteRequestReject &putSenderLocation(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 78, src, sizeof(char) * 10);
        return *this;
    }
    ...
    #if __cplusplus >= 201703L
    QuoteRequestReject &putSenderLocation(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 10)
        {
    ...
    #else
    QuoteRequestReject &putSenderLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 10)
        {
    ...
    SBE_NODISCARD char executingTrader(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 88 + (index * 1), sizeof(char));
        return (val);
    }

    QuoteRequestReject &executingTrader(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 88 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getExecutingTrader(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 88, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    QuoteRequestReject &putExecutingTrader(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 88, src, sizeof(char) * 5);
        return *this;
    }

    SBE_NODISCARD std::string getExecutingTraderAsString() const
    {
        const char *buffer = m_buffer + m_offset + 88;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    QuoteRequestReject &putExecutingTrader(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
        ...
        std::memcpy(m_buffer + m_offset + 88, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 5; ++start)
        {
            m_buffer[m_offset + 88 + start] = 0;
        }

        return *this;
    }
    #else
    QuoteRequestReject &putExecutingTrader(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
        ...
        std::memcpy(m_buffer + m_offset + 88, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 5; ++start)
        {
            m_buffer[m_offset + 88 + start] = 0;
        }
...
public:
    ...
    {
        m_fixedRate.wrap(m_buffer, m_offset + 93, m_actingVersion, m_bufferLength);
        return m_fixedRate;
    }
    ...
    {
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 101, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    QuoteRequestReject &daysToSettlement(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 101, &val, sizeof(std::uint16_t));
        return *this;
    }
...
public:
    ...
    QuoteRequestReject &putQuoteReqID(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    QuoteRequestReject &putQuoteReqID(const std::string &str)
    {
        if (str.length() > 20)
        {
    ...
    #if __cplusplus >= 201703L
    QuoteRequestReject &putQuoteReqID(const std::string_view str)
    {
        if (str.length() > 20)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    QuoteRequestReject &putDeskID(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    QuoteRequestReject &putDeskID(const std::string &str)
    {
        if (str.length() > 20)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    QuoteRequestReject &putDeskID(const std::string_view str)
    {
        if (str.length() > 20)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    QuoteRequestReject &putMemo(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    QuoteRequestReject &putMemo(const std::string &str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    QuoteRequestReject &putMemo(const std::string_view str)
    {
        if (str.length() > 40)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    QuoteRequestReject &putText(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    QuoteRequestReject &putText(const std::string &str)
    {
        if (str.length() > 250)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    QuoteRequestReject &putText(const std::string_view str)
    {
        if (str.length() > 250)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, QuoteRequestReject &_writer)
{
    QuoteRequestReject writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "QuoteRequestReject", )";
    ...
    builder << ", ";
    builder << R"("quoteRequestRejectReason": )";
    builder << +writer.quoteRequestRejectReason();
